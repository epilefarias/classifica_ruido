...
\begin{frame}
	...
	\begin{table}[h]
		\centering
		\caption{Matriz de confusão do classificador usando Rede Neural}
...
\begin{frame}
	...
	\begin{table}[ht]
\centering
\caption{Acurácia dos métodos estudados por classe.}
\label{tab:acc}
\resizebox{.65\textwidth}{!}{\begin{tabular}{l|llll}
\hline
