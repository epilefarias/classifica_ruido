...
%Muitas tarefas de Processamento de Sinais Acústicos são executadas em condições ruidosas. Quando há ruído, o desempenho de tais tarefas é inferior ao desempenho quando os sinais-alvo não têm ruído. \textbf{REFERENCIAS, REFERENCIAS}.
...
%O problema de classificação de ruído tem sido tratado em diversas áreas do conhecimento. \textbf{breve histórico aqui, com referências}.
