...
The confusion matrices for each method are shown in Tables \ref{tab:confusion_kmeans}, \ref{tab:confusion_gmm}, \ref{tab:confusion_svm} and \ref{tab:confusion_nn}.
